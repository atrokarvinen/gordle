...
// func (c Cli) CreateGameLoop() models.GameDto {
...
// func (c Cli) PrintGame(game models.GameDto) {
...
// func (c Cli) GameLoop(gameType models.GameDto) {
// 	newGame := c.Game
// 	gameId := gameType.Id
...
// 			break
// 		}
// 		guess := models.Guess{Word: guessedWord, GameTypeID: gameId}
